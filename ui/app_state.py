...
class AppState:
    def __init__(self, root: ctk.CTk):
        ...
        self.paths: RuntimePaths = prepare_runtime_paths()
        ...
        self.excel_var = ctk.StringVar(value=self._default_excel_path())
        self.template_var = ctk.StringVar(value=str(self.template_path) if self.template_path.exists() else "")
        self.output_dir_var = ctk.StringVar(value=str(self.paths.output_dir))
        self.output_name_var = ctk.StringVar(value=self._default_output_name())
        self.status_var = ctk.StringVar(value="Sẵn sàng")
        self.summary_var = ctk.StringVar(value="Chưa có dữ liệu")
        self.preview_limit_var = ctk.StringVar(value="50")
        self.form_mode_var = ctk.StringVar(value="Đang tạo dòng mới")
        ...
        self.po_sub_var = ctk.StringVar()
        self.box_var = ctk.StringVar()
        self.rev_var = ctk.StringVar()
        self.lot_var = ctk.StringVar()

        # Layout editor fields
        self.layout_choice_var = ctk.StringVar(value="")
        self.layout_label_var = ctk.StringVar(value="")
        self.layout_field_var = ctk.StringVar(value="")
        ...
        self.history_total_var = ctk.StringVar(value="0")
        self.history_today_var = ctk.StringVar(value="0")
        self.history_next_po_var = ctk.StringVar(value="--")
        self.history_status_var = ctk.StringVar(value="")
